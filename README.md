...
Test csv and img files could be found in the [02-src-data](src-data) folder
...
### Files definitions:
Source data and processed data should store in Minio. Minio service already defined in [docker-compose](docker-compose/docker-compose.yml) file.
...
Postgres DB service already defined in [docker-compose](docker-compose/docker-compose.yml)
...
The solution should work in docker-compose. As base template can be taken [docker-compose](docker-compose/docker-compose.yml) file.
